    ...
    return (
        <footer className="bg-white">
            <div className="mx-auto  space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <div className="text-teal-600">
                            <h2 className="text-4xl font-extrabold">Online Plant Sell</h2>
                        </div>

                        <p className="mt-4 max-w-xs text-gray-500">
                            Discover a green paradise! Shop our diverse selection of plants online. Bring nature home with ease and expert guidance.
                        </p>
                ...
                <p className="text-xs text-gray-500">&copy; 2024. Online Plant Sell. All rights reserved.</p>
            </div>
        </footer>
    );
};
